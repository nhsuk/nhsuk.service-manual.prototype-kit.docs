...
export default function (eleventyConfig) {
  ...
  eleventyConfig.addPlugin(nhsukEleventyPlugin, {
    ...
    opengraphImageUrl: 'https://prototype-kit.service-manual.nhs.uk/assets/images/nhs-prototype-kit-opengraph.png',
  ...
  eleventyConfig.addGlobalData(
    "downloadUrl",
    `https://github.com/nhsuk/nhsuk-prototype-kit/archive/refs/tags/v7.0.0.zip`
  );
